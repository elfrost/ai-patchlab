...
- **Next scan:** [homeassistant-ai/ha-mcp](homeassistant-ai-ha-mcp.html) — 2026-05-29, 0 real
- **Previous scan:** [aurelio-labs/semantic-router](aurelio-labs-semantic-router.html) — 2026-05-27, see write-up
