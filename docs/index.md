...
description: "84 curated security scans of open-source AI agents, MCP servers and LLM apps - 17 confirmed fixes, run local-first with Semgrep, Gitleaks, Trivy and pip-audit."
---
...
> [**work with me →**]({{ '/work-with-me' | relative_url }}). 84 scans, 17 confirmed fixes, methodology in the open.
...
84 scans, newest first. **Findings** is the raw count the tools produced;
