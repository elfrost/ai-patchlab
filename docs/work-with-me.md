...
Everything I'd do for you, I've done in the open — [43 curated scans]({{ '/' | relative_url }}) of well-known AI/agent projects, with **10 confirmed fixes** where maintainers acted on the findings, and a documented methodology behind each one.
